...
using NLog.Targets.Gelf.Core.Tests.Resources;

namespace NLog.Targets.Gelf.Core.UnitTest
{
    public class UdpTransportTest
    {
        ...
        public class SendMethod
        {
            ...
            public void ShouldSendLongUdpMessage()
            {
                ...
                transportClient.Verify(t => t.Send(It.IsAny<byte[]>(), It.IsAny<Int32>(), It.IsAny<IPEndPoint>()), Times.Exactly(3));
                converter.Verify(c => c.GetGelfJson(It.IsAny<LogEventInfo>(), It.IsAny<string>()), Times.Once());
            }
        }
